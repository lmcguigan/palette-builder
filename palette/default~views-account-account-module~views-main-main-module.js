(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~views-account-account-module~views-main-main-module"],{
...
class PaletteService {
    constructor(db, authService) {
        ...
        this.palettes$ = this.authService.user$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(user => !!user), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])((user) => {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["from"])(this.db.collection('palettes', ref => ref.where('ownerAuthId', '==', user.uid))
                .snapshotChanges()
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((actions) => {
                return actions.map(a => {
                    const data = a.payload.doc.data();
                    return Object.assign(Object.assign({}, data), { id: a.payload.doc.id });
                });
            })));
        }));
    }
...
PaletteService.ɵfac = function PaletteService_Factory(t) { return new (t || PaletteService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_3__["AngularFirestore"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PaletteService, [{
    ...
    }], function () { return [{ type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_3__["AngularFirestore"] }, { type: _auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"] }]; }, null); })();


/***/ })

}]);
//# sourceMappingURL=default~views-account-account-module~views-main-main-module.js.map